...
const resize = (config, context) => {
    ...
    return function resizeTransform(image) {
        ...
        if ((withoutEnlargement && (finalHeight > originalHeight || finalWidth > originalWidth)) ||
            ...
            context.logger.info('withoutEnlargement or withoutReduction enabled. Image width, height and aspect ratio reverted to original values');
        }
...
export { applyTransforms, blur, builtinOutputFormats, builtins, extractEntries, fitValues, flatten, flip, flop, format$1 as format, formatValues, generateImageID, generateTransforms, getBackground, getFit, getKernel, getMetadata, getPosition, getProgressive, getQuality, grayscale, hsb, invert, kernelValues, loadImage, median, metadataFormat, normalize, parseURL, pictureFormat, positionShorthands, positionValues, resize, resolveConfigs, rotate, setMetadata, sourceFormat, srcsetFormat, tint, urlFormat };
